  ...
  return (
    <section className="pricecheckstagssection">
      ...
      <div className="checkbox-container">
        ...
        <div className="check-box"><input type="checkbox" /><p className="salesIcon">NEW</p></div>
        <div className="check-box"><input type="checkbox" /><p className="salesIcon">TOP</p></div>
      </div>
    </section>
  )
};
